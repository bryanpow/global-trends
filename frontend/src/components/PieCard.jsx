  ...
  return (
    <>
        <div  style={{width: '308px', hieght: '100px'}} className='flex flex-col mt-1 p-5  justify-center cursor-pointer   transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl     bg-white   pt-10' >
            ...
            <PieChart width={400} height={300} style={{transform: 'scale(0.7) translateX(-92px)'}} > 
                <defs>
                ...
                <Legend iconType='circle' wrapperStyle={{  transform: 'translateY(60px) translateX(5px)', color: 'gray' }} />
                <Pie
                data={data5}
                cx="50%"
                cy="50%"
